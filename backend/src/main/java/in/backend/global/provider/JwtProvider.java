...
import static in.backend.global.exception.GlobalExceptionCode.EXPIRED_ACCESS_TOKEN;
import static in.backend.global.exception.GlobalExceptionCode.EXPIRED_REFRESH_TOKEN;
import static in.backend.global.exception.GlobalExceptionCode.INVALID_ACCESS_TOKEN;
import static in.backend.global.exception.GlobalExceptionCode.INVALID_REFRESH_TOKEN;

import in.backend.global.exception.InvalidJwtException;
import in.backend.global.exception.JwtExpiredException;
...
public class JwtProvider {
    ...
    private static final Long refreshTokenExpiry = (7 * 3) * 24 * 60 * 60L; // 3주
